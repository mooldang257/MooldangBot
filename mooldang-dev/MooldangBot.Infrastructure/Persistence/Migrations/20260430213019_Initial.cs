        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    song_no = table.Column<int>(type: "int", nullable: false),
                    streamer_profile_id = table.Column<int>(type: "int", nullable: false),
            ...
            // [v21.0-Manual]: MariaDB Vector columns addition (Excluded from EF Core Model to avoid mapping errors)
            migrationBuilder.Sql("ALTER TABLE func_song_master_library ADD title_vector vector(3072) NOT NULL;");
            // Vector index creation is handled manually to avoid "Specified key was too long" error in some MariaDB versions
            // migrationBuilder.Sql("CREATE INDEX ix_func_song_master_library_title_vector ON func_song_master_library (title_vector);");
            
            migrationBuilder.Sql("ALTER TABLE func_song_streamer_library ADD title_vector vector(3072) NULL;");
            migrationBuilder.Sql("ALTER TABLE func_song_books ADD title_vector vector(3072) NULL;");
            migrationBuilder.Sql("ALTER TABLE func_song_master_staging ADD title_vector vector(3072) NULL;");
        }
