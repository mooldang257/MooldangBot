...
public class ChatLogBufferService : IChatLogBufferService
{
    ...
    private readonly Channel<LogChatInteractions> _channel = Channel.CreateBounded<LogChatInteractions>(new BoundedChannelOptions(50000)
    {
    ...
    public void Enqueue(LogChatInteractions log)
    {
    ...
    public IAsyncEnumerable<LogChatInteractions> DrainAllAsync(CancellationToken ct)
    {
