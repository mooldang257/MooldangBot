...
이번에는 스트리머의 방송 환경을 책임지는 카테고리 2: Configuration & Overlay (설정 및 오버레이) 도메인의 정규화(v4.6)를 진행하시려는군요. AvatarSetting, OverlayPreset, PeriodicMessage 테이블 역시 기존 설계의 잔재인 무거운 ChzzkUid 문자열을 품고 있습니다.
