🛠️ 정규화 설계 포인트
ChzzkUid 제거: 무거운 문자열 대신 CoreStreamerProfiles 테이블의 정수형 기본키인 StreamerProfileId로 교체합니다.
...
1. 수정된 FuncCmdUnified.cs (엔티티 코드)
C#
using System;
...
modelBuilder.Entity<FuncCmdUnified>(entity => 
{
    ...
    entity.HasOne(c => c.CoreStreamerProfiles)
          .WithMany()
