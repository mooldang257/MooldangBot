...
namespace MooldangBot.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260419135451_AddPointSystemUniqueIndexes")]
    partial class AddPointSystemUniqueIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MooldangBot.Domain.Entities.SongBook", b =>
                {
                    b.HasOne("MooldangBot.Domain.Entities.StreamerProfile", "StreamerProfile")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_song_book_main_core_streamer_profiles_streamer_profile_id");
            ...
            modelBuilder.Entity("MooldangBot.Domain.Entities.SongQueue", b =>
                {
                    ...
                    b.HasOne("MooldangBot.Domain.Entities.SongBook", "SongBook")
                        ...
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_song_list_queues_song_book_main_song_book_id");
