...
namespace MooldangBot.Infrastructure.Migrations
{
    ...
    [Migration("20260401105844_NormalizeRouletteViewerData")]
    partial class NormalizeRouletteViewerData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MooldangBot.Domain.Entities.RouletteLog", b =>
                {
                    ...
                    b.Property<int?>("ViewerProfileId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ChzzkUid", "ViewerUidHash");
            ...
            modelBuilder.Entity("MooldangBot.Domain.Entities.ViewerProfile", b =>
                {
                    ...
                    b.HasIndex("StreamerChzzkUid", "ViewerUidHash")
                        .IsUnique();
            ...
            modelBuilder.Entity("MooldangBot.Domain.Entities.RouletteLog", b =>
                {
                    b.HasOne("MooldangBot.Domain.Entities.ViewerProfile", "ViewerProfile")
                        .WithMany()
