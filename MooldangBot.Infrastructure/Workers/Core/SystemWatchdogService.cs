...
{
    private const string WorkerName = nameof(SystemWatchdogService);
    ...
    {
        logger.LogInformation("🛡️ [SystemWatchdogService] 가동 시작 (설정: {Interval}s)", CurrentSettings.IntervalSeconds);
