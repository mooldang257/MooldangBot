...
namespace MooldangBot.Infrastructure.Migrations
{
    ...
    [Migration("20260405133301_Fixed_v13_Schema_Sync")]
    partial class Fixed_v13_Schema_Sync
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MooldangBot.Domain.Entities.Master_SongLibrary", b =>
                {
                    ...
                    b.HasIndex("MetadataKey")
                        .IsUnique()
                        .HasDatabaseName("ix_func_song_master_library_metadata_key");
            ...
            modelBuilder.Entity("MooldangBot.Domain.Entities.SongQueue", b =>
                {
                    ...
                    b.Property<long?>("MasterSongLibraryId")
                        .HasColumnType("bigint")
                        .HasColumnName("master_song_library_id");
                    ...
                    b.HasIndex("MasterSongLibraryId")
                        .HasDatabaseName("ix_song_list_queues_master_song_library_id");
            ...
            modelBuilder.Entity("MooldangBot.Domain.Entities.Streamer_SongLibrary", b =>
                {
                    ...
                    b.HasIndex("MasterSongLibraryId")
                        .HasDatabaseName("ix_func_song_streamer_library_master_song_library_id");

                    b.HasIndex("StreamerProfileId", "MasterSongLibraryId")
                        .IsUnique()
                        .HasDatabaseName("ix_func_song_streamer_library_streamer_profile_id_master_song_l");
            ...
            modelBuilder.Entity("MooldangBot.Domain.Entities.SongQueue", b =>
                {
                    ...
                    b.HasOne("MooldangBot.Domain.Entities.Master_SongLibrary", "MasterSongLibrary")
                        .WithMany()
                        .HasForeignKey("MasterSongLibraryId")
                        .HasConstraintName("fk_song_list_queues_master_song_libraries_master_song_library_id");
                    ...
                    b.Navigation("MasterSongLibrary");
            ...
            modelBuilder.Entity("MooldangBot.Domain.Entities.Streamer_SongLibrary", b =>
                {
                    b.HasOne("MooldangBot.Domain.Entities.Master_SongLibrary", "MasterSongLibrary")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_func_song_streamer_library_func_song_master_library_master_s");
